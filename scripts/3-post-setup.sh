...
if [[ "${DESKTOP_ENV}" == "kde" ]]; then
  ...
  $AUR_HELPER -S --noconfirm --needed sddm-git firefox nautilus gedit udiskie swaylock-effects cliphist qt5-wayland qt6-wayland wlogout pipewire wireplumber polkit-kde-agent
